...
*/
	var sul = ['Paraná',	'Curitiba',	'Santa Catarina', 'Rio Grande do Sul'];
...
// ?
	brasil.unshift('Amazonas','Amapa',  'Acre');
	console.log(brasil);
...
*/
	var nordeste = ['Bahia', 'Ceará','Maranhao','pernanbuco'];
